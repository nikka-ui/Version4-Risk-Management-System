...
<body style="font-family: Arial, sans-serif; color: #0f172a; line-height: 1.5; padding: 24px;">
  <p>Hello {{ $name }},</p>
  <p>Use this one-time code to sign in to the ACCC Risk Management System:</p>
  <p style="font-size: 28px; font-weight: 700; letter-spacing: 0.24em; margin: 24px 0;">{{ $otp }}</p>
  <p>This code expires in {{ $minutes }} minutes. If you did not request this code, you can ignore this email.</p>
